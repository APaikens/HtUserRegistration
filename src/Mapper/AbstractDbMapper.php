...
use HtUserRegistration\Entity\UserRegistrationInterface as UserRegistrationInterface;
...
abstract class AbstractDbMapper extends EventProvider
{
    ...
    /**
     * @param Select $select
     * @param UserRegistrationInterface|null $entityPrototype
     * @param HydratorInterface|null $hydrator
     * @return HydratingResultSet
     */
    protected function select(Select $select, UserRegistrationInterface $entityPrototype = null, HydratorInterface $hydrator = null)
    {
        $this->initialize();
     ...
     */
    protected function insert(UserRegistrationInterface $entity, $tableName = null, HydratorInterface $hydrator = null)
    {
        $this->initialize();
     ...
     * @return ResultInterface
     */
    protected function update(UserRegistrationInterface $entity, $where, $tableName = null, HydratorInterface $hydrator = null)
    {
        $this->initialize();
        $tableName = $tableName ?: $this->tableName;
        $sql = $this->getSql()->setTable($tableName);
    ...
    /**
     * @param UserRegistrationInterface $entityPrototype
     * @return AbstractDbMapper
     */
    public function setEntityPrototype(UserRegistrationInterface $entityPrototype)
    {
     ...
     * @return array
     */
    protected function entityToArray(UserRegistrationInterface $entity, HydratorInterface $hydrator = null)
    {
        if (!$hydrator) {
            $hydrator = $this->getHydrator();
        }
